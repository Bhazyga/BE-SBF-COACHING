...
{
    public function cetakLaporanMaterial()
    {
...
function fetch_data_material($materials)
{
  $rows = '';
...
class MaterialTCPDF extends \TCPDF
{
    function Header()
    {
        $materials = Material::all(); // Adjust this as needed for your data source
